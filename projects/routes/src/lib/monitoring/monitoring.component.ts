...
@Component({
  ...
  standalone: true,
  imports: [CardComponent, CommonModule, TableComponent, MatInputModule, FormsModule, ReactiveFormsModule, MatAutocompleteModule, MatFormFieldModule, FiltersComponent],
